...
rejection_ensemble.rejector.fit(balanced_pulse_train_loader, balanced_routing_train_targets, balanced_pulse_test_loader, balanced_routing_test_targets)

rejection_ensemble.rejector.eval(balanced_pulse_train_loader, balanced_routing_train_targets, balanced_pulse_test_loader, balanced_routing_test_targets)